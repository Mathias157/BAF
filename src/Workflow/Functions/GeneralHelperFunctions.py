...
def get_balmorel_kpis(
    ...
    if not return_df:
        ...
        df_cap = (
            ...
            .query(
                f'Technology != "H2-STORAGE" and not Technology.str.contains("INTERSEASONAL") and not Technology.str.contains("INTRASEASONAL") and Scenario.str.contains("{capital_scenario_string}")'
            )
            .pivot_table(
        ...
        df_sto = (
            ...
            .query(
                f'Technology == "H2-STORAGE" or Technology.str.contains("INTERSEASONAL") or Technology.str.contains("INTRASEASONAL") and Scenario.str.contains("{capital_scenario_string}")'
            )
            .pivot_table(
                index=["Scenario", "Year", "Country", "Region", "Technology", "Unit"],
                values="Value",
        ...
        df_emi = (
            ...
            .pivot_table(
                index=["Scenario", "Year", "Country", "Region", "Parameter", "Unit"],
                values="Value",
                aggfunc="sum",
            )
            .reset_index()
        ...
        # Adequacy
        df_adeq = get_adequacy(results)
        df_adeq = df_adeq.query(
            f'Scenario.str.contains("{operational_scenario_string}")'
        )

        df = pd.concat(
            (capital_costs, operational_costs, df_cap, df_sto, df_emi, df_adeq)
        )
...
class AntaresOutput:
    ...
    def __init__(
        self, result_name: str, folder_name: str = "Antares", wk_dir: str = "."
    ):
        # Set path to result
